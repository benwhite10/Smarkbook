...
function writeSelectedWorksheet(worksheet) {
    ...
    html_text += "<a class='selected_worksheet_button last' href='/worksheetSummary.php?wid=" + worksheet["Version ID"] + "'>Results Analysis</a>";
    ...
    html_text += "<div class='selected_worksheet_button remove' onclick='clickDelete(\"selected\")'>Delete</div>";
