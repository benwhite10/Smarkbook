                        ...
                        <div id="new_worksheet_report" class="half_column_report">
                            <div id="new_worksheet_report_title" class="report_column_title">
                                <div id="new_worksheet_report_title_top" class="report_column_title_top">
                                    <div id="section_details" class="title_sections selected" onclick="changeSection('section_details')"><h1>Details</h1></div>
                                    <div id="section_questions" class="title_sections" onclick="changeSection('section_questions')"><h1>Questions</h1></div>
